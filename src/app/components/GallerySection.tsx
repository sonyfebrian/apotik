...
const galleryItems = [
  {
    src: '/assets/gallery_ruang_terapi.jpeg',
    title: 'Ruang Terapi',
    description: 'Ruang terapi yang nyaman',
    span: 'col-span-1 row-span-2',
  },
  {
    src: '/assets/gallery_akupuntur.jpeg',
    title: 'Ruang Obat Herbal',
    description: 'Ruang obat herbal',
    span: 'col-span-1 row-span-1',
  },
  {
    src: '/assets/gallery_bekam.jpeg',
    title: 'Ruang Konsultasi',
    description: 'Ruang konsultasi yang nyaman dan privat',
    span: 'col-span-1 row-span-1',
  },
  {
    src: '/assets/gallery_resepsionis.jpeg',
    title: 'Area Resepsionis',
    description: 'Area penyambutan yang ramah dan profesional',
    span: 'col-span-1 row-span-1',
  },
  {
    src: '/assets/gallery_konsultasi.jpeg',
    title: 'Konsultasi Dokter',
    description: 'Konsultasi langsung dengan dokter berpengalaman',
    span: 'col-span-1 row-span-1',
  },
  {
    src: '/assets/gallery_itera.jpeg',
    title: 'Lokasi',
    description: 'Lokasi Griya Holistic Bergas Waras',
    span: 'col-span-1 row-span-1',
  },
  {
    src: '/assets/gallery_lokasi.jpeg',
    title: 'Lokasi',
    description: 'Lokasi Griya Holistic Bergas Waras',
    span: 'col-span-1 row-span-1',
  },
  {
    src: '/assets/gallery_lokasi_malem.jpeg',
    title: 'Lokasi',
    description: 'Lokasi Griya Holistic Bergas Waras',
    span: 'col-span-1 row-span-1',
  },
